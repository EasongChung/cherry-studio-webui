...
const textPacks = {
  ...
  'el-GR': {
    ...
    loadingOlderConversations: 'Φόρτωση παλαιότερων συνομιλιών...',
    loadOlderConversations: 'Φόρτωση παλαιότερων συνομιλιών',
    model: 'Μοντέλο',
  ...
  'ro-RO': {
    ...
    loadingOlderConversations: 'Se încarcă conversațiile mai vechi...',
    loadOlderConversations: 'Încărcați conversațiile mai vechi',
    model: 'Model',
  ...
  'vi-VN': {
    ...
    loadingOlderConversations: 'Đang tải cuộc trò chuyện sớm hơn...',
    loadOlderConversations: 'Tải cuộc trò chuyện sớm hơn',
    model: 'Mô hình',
